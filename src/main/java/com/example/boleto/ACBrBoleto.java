...
public final class ACBrBoleto extends ACBrLibBase {
    ...
    private static String ACBR_BOLETO_DLL = "/lib64/libacbrboleto64.so";
    private static String CEDENTE_INI = "src/main/resources/arquivos_ini/cedente.ini";

    private static String TITULO_INI = "src/main/resources/arquivos_ini/titulo.ini";

    private static String DIRETORIO = "src/main/resources/arquivos_ini";
